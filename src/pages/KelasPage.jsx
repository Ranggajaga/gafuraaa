    ...
    <div className="kelas min-vh-100">
      <Container>
        <Row>
          ...
          <p className="text-center animate__animated animate__fadeInUp animate__delay-1s">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque esse commodi veritatis officiis amet. Quae cupiditate asperiores sequi temporibus illo iste facere, repellat optio, ratione expedita dolore, similique voluptas sunt.</p>
            </Col>
        </Row>
        <Row>
